...
import '../screens/auth/vehicle_information_screen.dart';
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) {
          final isDriverFlow = state.extra as bool? ?? false;
          return PhoneScreen(isDriverFlow: isDriverFlow);
        },
      ),
      GoRoute(
        ...
        builder: (context, state) {
          ...
          return VerifyOtpScreen(registrationData: registrationData);
        },
      ),
      GoRoute(
        path: '/auth/signup',
