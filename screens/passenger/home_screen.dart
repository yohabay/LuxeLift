                    ...
                    children: [
                      ...
                      LocationSearchWidget(
                        onLocationSelected: (pickup, dropoff) {
                          context.go('/passenger/luxury-booking');
                        },
                      ),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: _QuickActionButton(
                              ...
                              label: 'Rewards',
                              onTap: () => context.go('/passenger/loyalty-rewards'),
                            ),
                          ),
                        ],
                      ),
                      ...
                      // Luxury Customization Button
                      Container(
                        width: double.infinity,
                        margin: const EdgeInsets.only(bottom: 16),
                        child: OutlinedButton.icon(
                          onPressed: () => context.go('/passenger/ride-customization'),
                          icon: const Icon(Icons.tune),
                          label: const Text('Customize Your Ride Experience'),
